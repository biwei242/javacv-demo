 ...
 * @see <href = "https://cloud.tencent.com/developer/article/1912831?from=15425">JavaCV推流实战(MP4文件)</href>
...
public class PushMp4 {
     ...
     */
    private static final String MP4_FILE_PATH = "d:/vod/b.flv";

    /**
     * SRS的推流地址
     */
    private static final String SRS_PUSH_ADDRESS = "rtmp://xxx";
    ...
    /**
     * 调用ffmpeg命令 一边拉流一边推流，原始命令如下：
     * ffmpeg.exe -re -i "https://
     * @throws Exception
     */
    private static void exeFfmpeg() throws Exception {
     ...
     * @throws Exception
     */
    private static void exeFfmpeg2() throws Exception {
        String ffmpeg = Loader.load(org.bytedeco.ffmpeg.ffmpeg.class);
        ProcessBuilder pb = new ProcessBuilder(ffmpeg, "-re",
                "-i", "http://拉流地址",
                "-i", "C:\\Users\\baiqi\\Pictures\\1.png",
                "-filter_complex", "[1:v]scale=300:200[wm];[0:v][wm]overlay=W-w-10:H-h-10",
                "-c:v", "libx264",
                "-c:a", "copy",
                "-f", "flv",
                "rtmp://推流地址"
...
//        String ffmpeg = Loader.load(org.bytedeco.ffmpeg.ffmpeg.class);
//        ProcessBuilder pb = new ProcessBuilder(ffmpeg, "-configure", "--help");
//        pb.inheritIO().start().waitFor();
        exeFfmpeg2();
